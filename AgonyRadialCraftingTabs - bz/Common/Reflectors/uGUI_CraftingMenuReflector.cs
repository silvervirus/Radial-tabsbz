...
namespace Agony.Common.Reflectors
{
	...
	internal static class uGUI_CraftingMenuReflector
	{
		...
		public static void SetCraftedNode(uGUI_CraftingMenu menu , uGUI_CraftingMenu.Node craftedNode)
		{
			if (menu == null)
			{
				throw new ArgumentNullException("menu is null");
		...
		public static uGUI_CraftingMenu.Node GetIcons(uGUI_CraftingMenu menu)
		{
			if (menu == null)
			{
				throw new ArgumentNullException("menu is null");
			}
			return (uGUI_CraftingMenu.Node)uGUI_CraftingMenuReflector.iconsFieldInfo.GetValue(menu);
		}
